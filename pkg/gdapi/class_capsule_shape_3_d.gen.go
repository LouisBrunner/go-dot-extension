...
func  (me *CapsuleShape3D) GetRadius() float32 {
  classNameV := StringNameFromStr("CapsuleShape3D")
  defer classNameV.Destroy()
...
func  (me *CapsuleShape3D) GetHeight() float32 {
  classNameV := StringNameFromStr("CapsuleShape3D")
  defer classNameV.Destroy()
...
func (me *CapsuleShape3D) GetPropRadius() float32 {
  panic("TODO: implement")
}

func (me *CapsuleShape3D) SetPropRadius(value float32) {
  panic("TODO: implement")
}

func (me *CapsuleShape3D) GetPropHeight() float32 {
  panic("TODO: implement")
}

func (me *CapsuleShape3D) SetPropHeight(value float32) {
  panic("TODO: implement")
}