...
func  (me *ArrayMesh) AddSurfaceFromArrays(primitive MeshPrimitiveType, arrays Array, blend_shapes Array, lods Dictionary, flags MeshArrayFormat, )  {
  ...
  defer methodNameV.Destroy()
  methodPtr := giface.ClassdbGetMethodBind(classNameV.AsCPtr(), methodNameV.AsCPtr(), 172284304) // FIXME: should cache?
...
func (me *ArrayMesh) GetPropBlendShapeMode() int {
  panic("TODO: implement")
}

func (me *ArrayMesh) SetPropBlendShapeMode(value int) {
  panic("TODO: implement")
}

func (me *ArrayMesh) GetPropCustomAabb() AABB {
  panic("TODO: implement")
}

func (me *ArrayMesh) SetPropCustomAabb(value AABB) {
  panic("TODO: implement")
}

func (me *ArrayMesh) GetPropShadowMesh() ArrayMesh {
  panic("TODO: implement")
}

func (me *ArrayMesh) SetPropShadowMesh(value ArrayMesh) {
  panic("TODO: implement")
}